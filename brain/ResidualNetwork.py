...
class ResidualNetwork:
	...
	def __init__(self, initPath):
		...
		with g.as_default():
			...
			l1 = self.__addResnetBlock(input, 692 + 4209)
			l2 = self.__addResnetBlock(l1, 692 + 4209)
			l3 = self.__addResnetBlock(l2, 692 + 4209)
			l4 = self.__addResnetBlock(l3, 692 + 4209)
			l5 = self.__addResnetBlock(l4, 692 + 4209)
			l6 = self.__addResnetBlock(l5, 692 + 4209)
			l7 = self.__addResnetBlock(l6, 692 + 4209)
			l8 = self.__addResnetBlock(l7, 692 + 4209)
			z = self.__addLayer(l8, 692 + 4209, 4209)
	...
	def __addResnetBlock(self, input, inputSize):
		w1 = tf.Variable(tf.random_uniform([inputSize, inputSize], -0.001, 0.0012))
		b1 = tf.Variable(tf.random_uniform([1, inputSize], 0, 0.01))
		z1 = tf.matmul(input, w1) + b1
		o1 = tf.nn.relu(z1)
		w2 = tf.Variable(tf.random_uniform([inputSize, inputSize], -0.001, 0.0012))
